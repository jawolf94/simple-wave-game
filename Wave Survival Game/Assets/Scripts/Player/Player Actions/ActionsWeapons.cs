...
{
    // Vars set in Unity UI

    /// <summary>
    /// Amount of time before a player can use their weapon again.
    /// </summary>
    public float CoolDown;

    /// <summary>
    /// How far a player's weapon can shoot.
    /// </summary>
    public float ShotRange;

    /// <summary>
    /// How much damage a player's weapon applies
    /// </summary>
    ...
    void Start()
    {
        ...
        // Associate Line Renderer Component
    ...
    {
        // Hide the weapon effect after desired time period
    ...
    /// <summary>
    /// Function  to fire the player's weapon
    /// </summary>
    public void Fire()
    {
    ...
    /// <summary>
    /// Stop display of weapon effects
    /// </summary>
    ...
    private void fire() {
        ...
        // If the Ray hit any objects in Shootable Mask
