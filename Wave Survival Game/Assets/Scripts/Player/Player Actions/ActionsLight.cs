...
/// <summary>
/// Handles all player inputs related to lights.
/// </summary>
public class ActionsLight : MonoBehaviour, IPlayerAction
{
    ...
    public void OnTriggerExit(Collider other)
    {
        ...
        // Mark switch out of range if leaving collider
        if (other.tag.Equals("Switch"))
        {
    ...
    /// </summary>
    /// <param name="objectToCalc">Object to calculate the half width of</param>
