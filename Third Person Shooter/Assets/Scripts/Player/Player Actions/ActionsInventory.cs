...
public class ActionsInventory : MonoBehaviour, IPlayerAction
{
    ...
    void Start()
    {
        ...
        //Lists which keep track of the UI buttons representing items in the player's inventory
        ...
        //List of items which correspond with each UI item
    ...
    //Called when the player enter's a Trigger Collider
    ...
    public void ScrollPrimary(bool up)
    {
        ...
        if (up)
        {
            ...
            //Sey the primary index to 0 if the player scrolled up past the last index. 
